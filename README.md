...
- Vial View tab visually shows each vial currently on hand, grouped by peptide with a distinct high-contrast color palette.
- 1K Foot View combines every on-hand vial into one continuous color-coded mosaic, with a compact matching legend for the full inventory picture.
...
```text
ghcr.io/skrems/peptide-inventory:v1.7
```
